...
import img1 from "../../../images/Service-page/service-big-paint-4.jpg";
  ...
  return (
    <div>
      <div className="about-bg mt-20">
        <h1 className="about-text">Paint Master</h1>
      ...
      <div className="house-flex">
        <div>
          <div data-aos="fade-left" className="links">
            ...
            <Link
              className="link flex ml-5 items-center"
        ...
        <div data-aos="fade-up">
          ...
          <h1 className="serv-text"> Paint Master</h1>
